...
async function sendDnsHandsFreeEmail(client) {
  ...
  await sendEmail({
    to: d.email,
    subject: `🔧 Almost There — One Quick Step to Connect Your Domain — ${d.businessName}`,
    html: `<div style="font-family:sans-serif;max-width:660px;margin:0 auto;">
      <div style="background:linear-gradient(135deg,#0066FF,#1a1a2e);padding:28px 32px;border-radius:12px 12px 0 0;">
        <h1 style="color:#00D68F;margin:0;font-size:24px;">🔧 Almost Hands-Free</h1>
        <p style="color:rgba(255,255,255,.85);margin:8px 0 0;">One quick step to connect <strong>${domain}</strong> to your new site</p>
      </div>
      <div style="padding:28px 32px;">
        <p>Hi ${d.ownerName || 'there'},</p>
        <p>Good news — we've done the heavy lifting. Your website is built, and we've already configured everything on the technical side to receive your domain.</p>
        <p>There is <strong>one step only you can do</strong> — updating the nameservers at your domain registrar. This is a 2-minute change that tells the internet your domain now lives with us. Here's exactly how:</p>

        <div style="background:#f0f9ff;border:2px solid #0066FF;border-radius:12px;padding:24px;margin:24px 0;">
          <h3 style="margin:0 0 16px;color:#0066FF;">📋 What You Need to Do</h3>
          <ol style="padding-left:20px;line-height:2.4;font-size:14px;color:#374151;">
            <li>Log in to wherever you registered your domain (<strong>${(d.domainRegistrar || 'your registrar').replace(/_/g,' ')}</strong>)</li>
            <li>Find the <strong>Nameservers</strong> setting for <strong>${domain}</strong> — it's usually under "DNS" or "Domain Settings"</li>
            <li>Change the nameservers to the two values below</li>
            <li>Save the change — it typically takes 1–4 hours to take effect worldwide</li>
          </ol>
        </div>

        <div style="background:#1a1a2e;border-radius:12px;padding:24px;margin:24px 0;text-align:center;">
          <p style="color:rgba(255,255,255,.7);font-size:13px;margin:0 0 16px;text-transform:uppercase;letter-spacing:1px;">Your New Nameservers</p>
          <div style="background:#0066FF;color:white;font-family:monospace;font-size:18px;font-weight:700;padding:12px 20px;border-radius:8px;margin-bottom:10px;letter-spacing:1px;">vera.ns.cloudflare.com</div>
          <div style="background:#0066FF;color:white;font-family:monospace;font-size:18px;font-weight:700;padding:12px 20px;border-radius:8px;letter-spacing:1px;">walt.ns.cloudflare.com</div>
          <p style="color:rgba(255,255,255,.5);font-size:12px;margin:14px 0 0;">Replace any existing nameservers with exactly these two values</p>
        </div>

        ${emailWarning}

        <div style="background:#f0fff4;border:2px solid #00D68F;border-radius:12px;padding:24px;margin:24px 0;">
          <h3 style="margin:0 0 12px;color:#065f46;">✅ What Happens After You Do This</h3>
          <ol style="padding-left:20px;line-height:2.4;font-size:14px;color:#374151;">
            <li>DNS propagates — typically 1–4 hours, sometimes up to 24 hours</li>
            <li>Your domain <strong>${domain}</strong> starts pointing to your new TurnkeyAI website</li>
            <li>We'll send you a confirmation email with your live site URL and dashboard login</li>
          </ol>
        </div>

        <div style="background:#fff8ed;border:2px solid #f59e0b;border-radius:10px;padding:18px;margin:20px 0;">
          <p style="font-weight:700;color:#92400e;margin:0 0 8px;">🤔 Need Help With This Step?</p>
          <p style="font-size:14px;color:#92400e;margin:0;line-height:1.7;">Call us at <strong>(603) 922-2004</strong> and we'll walk you through it in under 5 minutes. Or reply to this email and we'll send you screenshots specific to your registrar.</p>
        </div>
        ...
        <div style="background:#f8fafc;border:2px solid #e5e7eb;border-radius:10px;padding:18px;margin:20px 0;">
          ...
          <p style="font-size:14px;color:#6B7280;margin:0;line-height:1.7;">The registrar login information you provided is encrypted and stored securely. It will only be used if you need further assistance. Once your domain is live, we recommend changing your registrar password for added peace of mind.</p>
        </div>
