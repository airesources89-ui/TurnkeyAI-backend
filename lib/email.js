...
async function sendCredentialsEmail(client) {
  const dashUrl = `${BASE_URL}/pages/client-dashboard.html?email=${encodeURIComponent(client.data.email)}`;
    ...
    html: `<div style="font-family:sans-serif;max-width:600px;margin:0 auto;">
      ...
      <div style="padding:32px;">
        ...
        <div style="background:#f0f9ff;border:2px solid #0066FF;border-radius:12px;padding:24px;margin:24px 0;">
          ...
          <p style="margin:8px 0 0;"><strong>Email:</strong> ${client.data.email}</p>
