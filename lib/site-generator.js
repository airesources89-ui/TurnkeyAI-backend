...
<section class="page-hero">
  <div class="container">
    ...
    <p style="color:rgba(255,255,255,.75);font-size:1.05rem;max-width:520px;margin:1rem auto 0;line-height:1.7;">Fill out the form and we'll confirm within the hour.</p>
  </div>
</section>
  ...
  <div class="container">
    <div class="booking-wrap">
      <div class="reveal">
        ...
        ${hoursData.length ? `<div style="margin-top:2rem;background:white;border-radius:14px;padding:1.5rem;border:1px solid #e5e7eb;"><h4 style="font-size:.95rem;font-weight:700;color:#0a1628;margin-bottom:1rem;"><i class="fas fa-clock" style="color:${pal.accent};margin-right:.4rem;"></i> Business Hours</h4>${hoursRowsLight}</div>` : ''}
      </div>
