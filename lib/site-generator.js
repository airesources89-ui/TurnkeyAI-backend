...
// ── Future: template variants, A/B testing, multi-page, blog pages
// ════════════════════════════════════════════════
...
Answer customer questions using the information above. If you do not know a specific answer, say you will have someone follow up and provide the phone number. Do not make up information. Keep responses concise (under 200 words).`;
  ...
  // ── Preview banner vs live Powered-by bar ──
...
<footer>
  <div class="footer-inner">
    ...
    <div class="footer-links">
      <a href="#services">Services</a><a href="#why">About</a><a href="#reviews">Reviews</a><a href="#booking">Book</a><a href="#contact">Contact</a>${(!isPreview && clientObj && clientObj.dashToken) ? '<a href="' + BASE_URL + '/pages/client-dashboard.html?token=' + clientObj.dashToken + '" style="color:' + pal.accent + ';font-weight:600;">My Dashboard</a>' : ''}${!isPreview ? '<a href="' + BASE_URL + '/pages/client-dashboard.html" style="color:rgba(255,255,255,.55);font-size:.82rem;">Client Login</a>' : ''}
    </div>
  </div>
